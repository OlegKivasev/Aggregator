...
- PartKOM uses only the official Web Services v4 API with Basic authentication. Credentials entered in the supplier settings are kept only in process memory; there is no browser-session fallback.
