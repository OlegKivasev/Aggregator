...
- Основная таблица показывает только точные предложения. Контекстное меню строки по правой кнопке мыши содержит действие «Показать аналоги»; оно открывает отдельное модальное окно с выбранной позицией, прогрессом поиска и таблицей аналогов.
